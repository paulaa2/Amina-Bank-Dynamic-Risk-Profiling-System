        ...
        {!loading &&
          filtered.map((company) => {
            ...
            return (
              <Card
                key={company.id}
                className="w-full border-slate-800 bg-slate-900 hover:border-slate-700 transition-colors"
              >
                <CardContent className="p-0">
                  <div className="flex items-center gap-4 px-5 py-4">
                    {/* Icon */}
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center bg-slate-800 border border-slate-700">
